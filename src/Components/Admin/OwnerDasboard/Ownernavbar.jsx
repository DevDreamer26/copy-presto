      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
            ...
            >
              <MenuItem onClick={handleCloseNavMenu}>
                <Box display="flex" flexDirection="column" alignItems="center">
                  <Link to ="/Shop" style={{ textDecoration: 'none' }}><Button sx={{ color: 'green' }}>Shops</Button></Link>
                  {/* <Link to ="/Items" style={{ textDecoration: 'none' }}><Button sx={{ color: 'green' }}>Items</Button></Link> */}
                </Box>
              </MenuItem>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              ...
              >
                <Link to ="/Shop" style={{ textDecoration: 'none', color:"black" }}>Shops</Link>
              </Button>
              <Button
                onClick={handleCloseNavMenu}
                sx={{ my: 2, color: 'black', display: 'block' }}

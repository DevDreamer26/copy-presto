  ...
  return (
    <>
      ...
      <div class="container">
        ...
        <h1>Welcome to prestoclean!</h1>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of PRESTOCLEAN's Website, located at prestoclean.in.
        </p>

        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use prestoclean if you do not agree to
        ...
        <section>
          ...
          <p>
            ...
            By accessing prestoclean, you agreed to use the required cookies.
          </p>
          <p>
        ...
        <section>
          <h2>License:</h2>
          <p>
            Unless otherwise stated, PRESTOCLEAN and/or its licensors own the
            intellectual property rights for all material on prestoclean. All
            intellectual property rights are reserved.You may access this from
            prestoclean for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>
            You must not:
            <ul>
              <li>Copy or republish material from prestoclean</li>
              <li>Sell, rent, or sub-license material from prestoclean</li>
              <li>Reproduce, duplicate or copy material from prestoclean</li>
              <li>Redistribute content from prestoclean</li>
            </ul>
            <p>
              ...
              PRESTOCLEAN does not filter, edit, publish or review Comments
              before their presence on the website. Comments do not reflect the
              views and opinions of PRESTOCLEAN, its agents, and/or affiliates.
              ...
              laws, PRESTOCLEAN shall not be liable for the Comments or any
              ...
              <br />
              <br />
              PRESTOCLEAN reserves the right to monitor all Comments and remove
              ...
              You hereby grant PRESTOCLEAN a non-exclusive license to use,
        ...
        <section>
          ...
          <p>
            ...
            compensates the absence of PRESTOCLEAN; and (d) the link is in the
            ...
            to PRESTOCLEAN. Please include your name, your organization name,
            ...
            a response. Approved organizations may hyperlink to our Website as
            follows: By use of our corporate name; or By use of the uniform
            resource locator being linked to; or Using any other description of
            ...
            PRESTOCLEAN's logo or other artwork will be allowed for linking
